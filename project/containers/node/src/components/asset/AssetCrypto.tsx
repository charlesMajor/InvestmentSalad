...
import { AssetGet, AssetType, CryptoGet, TagGet } from "@/lib/services/returnTypes";
...
export default function AssetCrypto({ objectAsset, setModifyOpen, setAssetToModify }: AssetProps) {
