...
public class FullUserDtoCustomValidator implements CustomValidator<FullUserDto, String> {

	private final Validator defaultHibernateValidator;
	private List<String> errorMessages;

	public FullUserDtoCustomValidator(Validator validator) {
	...
	@Override
	public void validate(FullUserDto dto) {
		Set<ConstraintViolation<FullUserDto>> violations = defaultHibernateValidator.validate(dto, Default.class);
	...
	@Override
	public void validate(String id, FullUserDto dto) {
		validateId(id);
		validate(dto);
