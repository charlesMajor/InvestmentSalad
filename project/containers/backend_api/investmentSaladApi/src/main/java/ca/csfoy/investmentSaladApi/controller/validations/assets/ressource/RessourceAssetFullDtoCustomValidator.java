...
public class RessourceAssetFullDtoCustomValidator implements CustomValidator<RessourceAssetFullDto, String>{
	private final Validator defaultHibernateValidator;
    private List<String> errorMessages;
    
    public RessourceAssetFullDtoCustomValidator(Validator validator) 
    {
	...
	@Override
	public void validate(RessourceAssetFullDto dto)
	{
		  Set<ConstraintViolation<RessourceAssetFullDto>> violations = defaultHibernateValidator.validate(dto, Default.class);
	...
	@Override
	public void validate(String id, RessourceAssetFullDto dto) {
