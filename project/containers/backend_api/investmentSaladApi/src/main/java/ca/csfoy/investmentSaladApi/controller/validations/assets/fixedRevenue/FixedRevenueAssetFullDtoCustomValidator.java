package ca.csfoy.investmentSaladApi.controller.validations.assets.fixedRevenue;
...
@Component
@Scope("prototype")
public class FixedRevenueAssetFullDtoCustomValidator implements CustomValidator<FixedRevenueAssetFullDto, String> {
	private final Validator defaultHibernateValidator;
    private List<String> errorMessages;
    
    public FixedRevenueAssetFullDtoCustomValidator(Validator validator) 
    {
	...
	@Override
	public void validate(FixedRevenueAssetFullDto dto)
	{
		  Set<ConstraintViolation<FixedRevenueAssetFullDto>> violations = defaultHibernateValidator.validate(dto, Default.class);
	...
	@Override
	public void validate(String id, FixedRevenueAssetFullDto dto) {
