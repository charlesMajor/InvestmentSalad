...
@Component
@Scope("prototype")
public class CryptoAssetDtoCustomValidator implements CustomValidator<CryptoAssetDto, String> {

	private final Validator defaultHibernateValidator;
	private List<String> errorMessages;

	public CryptoAssetDtoCustomValidator(Validator validator) {
	...
	@Override
	public void validate(CryptoAssetDto dto) {
		Set<ConstraintViolation<CryptoAssetDto>> violations = defaultHibernateValidator.validate(dto, Default.class);
	...
	@Override
	public void validate(String id, CryptoAssetDto dto) {
		validateId(id);
		validate(dto);
	}
