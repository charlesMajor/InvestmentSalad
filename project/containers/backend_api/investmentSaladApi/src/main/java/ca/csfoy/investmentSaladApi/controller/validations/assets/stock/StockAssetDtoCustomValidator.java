...
@Component
@Scope("prototype")
public class StockAssetDtoCustomValidator implements CustomValidator<StockAssetDto, String> {
	private final Validator defaultHibernateValidator;
	private List<String> errorMessages;

	public StockAssetDtoCustomValidator(Validator validator) {
	...
	@Override
	public void validate(StockAssetDto dto) {
		Set<ConstraintViolation<StockAssetDto>> violations = defaultHibernateValidator.validate(dto, Default.class);
	...
	@Override
	public void validate(String id, StockAssetDto dto) {
		validateId(id);
		validate(dto);
	}
