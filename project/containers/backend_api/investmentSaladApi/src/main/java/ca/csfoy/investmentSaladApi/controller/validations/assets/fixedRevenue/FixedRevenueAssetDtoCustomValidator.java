...
@Component
@Scope("prototype")
public class FixedRevenueAssetDtoCustomValidator implements CustomValidator<FixedRevenueAssetDto, String> {
	private final Validator defaultHibernateValidator;
    private List<String> errorMessages;
    
    public FixedRevenueAssetDtoCustomValidator(Validator validator) 
    {
	...
	@Override
	public void validate(FixedRevenueAssetDto dto)
	{
		  Set<ConstraintViolation<FixedRevenueAssetDto>> violations = defaultHibernateValidator.validate(dto, Default.class);
	...
	@Override
	public void validate(String id, FixedRevenueAssetDto dto) {
		validateId(id);
		validate(dto);
	}
